...
WANTED = ["Id","Market","Manufacturer","Model","Category","Badge","BadgeDetail",
...
def shape_rows(df_raw: pd.DataFrame, pageid: str, category_fallback: str, market_key: str) -> pd.DataFrame:
    ...
    df["Category"] = (df_raw["Category"] if "Category" in df_raw.columns
                             else df_raw.get("CategoryName", pd.Series([category_fallback]*len(df_raw))))
